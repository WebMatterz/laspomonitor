...
<link href="{{ asset('css/css/jquery-ui-1.8.18.custom.css') }}" rel="stylesheet" type="text/css"/>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="row">
                        ...
                        <h3>Congratulations, {{auth()->user()->firstname}} <br></h3>

							<p>Kindly download the grant application form here. <a href="{{URL::to('/')}}/images/srgform.doc" target="_blank"> Download Form</a> </p>
