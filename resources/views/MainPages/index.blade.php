						...
						<div class="swiper-slide dark">
							<div class="container">
								<div class="slider-caption slider-caption-center">
									...
									<h2> <a style="background-color: white; padding: 0.5em; border-radius: 1em;" href="{{ URL::to('login') }}"> Login </a>
								</div>
							</div>
		...
		<section id="content">
           ...
           <!--     <div class="container">
					<div class="row align-items-center">
						...
						<a href="{{ URL::to('login') }}" data-toggle="modal" data-target="#myModal"></a>
					</div>
				</div>
-->
<!-- 
