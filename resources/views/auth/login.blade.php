						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item mega-menu">
									<a class="menu-link" href="{{ URL::to('about') }}"><div>About</div></a>
								</li>
                <li class="menu-item mega-menu">
									<a class="menu-link" href="{{ URL::to('schedule') }}"><div>Schedule</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="{{ URL::to('contact') }}"><div>Contact</div></a>
								</li>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="tabs mx-auto mb-0 clearfix" id="tab-login-register" style="max-width: 500px;">
                        ...
                        <h3>Don't have an account? Sign up <a href="{{ URL::to('register') }}">here</a></h3>
