...
<head>
    <meta charset="utf-8">
       <title>{{ config('app.name', 'SRG FIRAT') }} | User Reset Password</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="SRG FIRAT Reset Password" name="Scrabble Connect" />
        <meta content="Research" name="khaleel Rahmon" />
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            <div class="bg-soft-success" style="background: teal !important;">
                                <div class="row">
                                    <div class="col-7">
                        ...
                        @endif
                         ...
                         <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© 2021 - {{date('Y')}} Scrabble Connect</p>
                            </div>
                        </div>
