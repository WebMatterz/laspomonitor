			...
			<div class="content-wrap">
              ...
              @if ($errors->has('email'))
                            ...
                            @endif
								...
								<div class="col-6 form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                  ...
                  @if ($errors->has('username'))
								...
								<div class="col-6 form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                  ...
                  @if ($errors->has('firstname'))
								...
								<div class="col-6 form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
									<label for="member-form-lastname">Lastname:</label>
									<input type="text" name="lastname" id="lastname" class="form-control" value="{{ old('lastname') }}" required autofocus />
                ...
                <div class="col-6 form-group{{ $errors->has('phone_no') ? ' has-error' : '' }}">
              <label for="fname">Phone No:</label>
              <input type="tel" name="phone_no" id="phone_no" class="form-control" value="{{ old('phone_no') }}" required>
               ...
               @if ($errors->has('phone_no'))
                                ...
                                <div class="col-6 form-group{{ $errors->has('designationID') ? ' has-error' : '' }}">
