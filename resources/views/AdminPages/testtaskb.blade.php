          ...
          <form id="taskForm"  class="mb-0" method="POST" action="{{route('task.store')}}">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="lecturerName" name="lecturerName" placeholder="Lecturer Name" value="{{ $lecturers->lecturerFname }} {{ $lecturers->lecturerLname }}"/>
                                ...
                                <label for="first-name">Lecturer Name:</label>
                                        <select name="supervisorName" id="supervisorName" class="form-control">
                                                        ...
                                                        @foreach ($supervisor as $supervisor)
                                                            <option value="{{ $supervisor->firstname }} {{ $supervisor->lastname }}">{{ $supervisor->firstname }} {{ $supervisor->lastname }}</option>">
                                                        @endforeach
                                                    </select>
                                         </div>
