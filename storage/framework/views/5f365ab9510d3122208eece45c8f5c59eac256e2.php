 ...
 -->
                     ...
                     <!--    <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item"
                               >
                                <img class="" src="<?php echo e(asset('assets/images/flags/us.jpg')); ?>" alt="Header Language" height="16">
                            </button>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="<?php echo e(asset('assets/images/users/noimage.jpg')); ?>"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ml-1" style="color: #fff;"><?php echo e(auth()->guard('admin')->user()->name); ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item d-block" href="<?php echo e(route('admin.resetpassword')); ?>"><i class="bx bx-wrench font-size-16 align-middle mr-1"></i> Settings</a>
                        ...
                        <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" href="<?php echo e(route('admin.logout')); ?>" onclick="event.preventDefault();
...
<?php /**PATH C:\wamp64\www\laspomonitor\resources\views/AdminInc/header.blade.php ENDPATH**/ ?>