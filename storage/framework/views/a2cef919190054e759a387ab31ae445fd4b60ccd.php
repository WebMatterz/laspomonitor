                            ...
                            <div class="card-body bg-white shadow">
                                ...
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <script type="text/javascript" src="<?php echo e(asset('assets/js/webcam.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/app.js')); ?>"></script>
 ...
 <!--<script src="<?php echo e(asset('assets/js/webcam.min.js')); ?>" type="text/javascript"></script> 
