  ...
  <div class="col-lg-12">
      <div class="card shadow">
          <div class="card-body" style="background: teal;">
            ...
            <form action="<?php echo e(route('user.settingsupdate')); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="col">
    <div class="form-group">
          <label style="color: #fff;">LastName</label>
           <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo e(auth()->user()->lastname); ?>">
         <small style="color: #fff; font-weight: 700;"></small>
        </div>
  </div>
  ...
  <div class="col-6">
     <div class="form-group">
          <label style="color: #fff;">Phone Number</label>
           <input type="tel" class="form-control" id="phone_no" name="phone_no" value="<?php echo e(auth()->user()->phone_no); ?>" >
         <small style="color: #fff; font-weight: 700;"></small>
        </div>
  </div>
  ...
  <div class="col-6">
     <div class="form-group">
          <label style="color: #fff;">Designation ID</label>
           <input type="text" class="form-control" id="designationID" name="designationID" value="<?php echo e(auth()->user()->designationID); ?>" >
         <small style="color: #fff; font-weight: 700;"></small>
        </div>
  </div>
...
swal("Phone Contact!", "Field is required", "info");
    ...
    $('#settings_button').hide();   
        ...
        url:"<?php echo e(route('user.settingsupdate')); ?>",
        method:"POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laspomonitor\resources\views/UserPages/settings.blade.php ENDPATH**/ ?>