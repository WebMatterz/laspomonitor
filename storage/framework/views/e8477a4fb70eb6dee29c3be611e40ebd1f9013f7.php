                    ...
                    <div class="tab-content" id="tab-login">
                        <div class="card my-3">
                            <div class="card-body bg-white shadow">
                                <form id="lecturerForm"  class="mb-0" method="POST" action="<?php echo e(route('lecturer.store')); ?>">
...
<?php echo $__env->make('AdminLayouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laspomonitor\resources\views/AdminPages/newlecturer.blade.php ENDPATH**/ ?>