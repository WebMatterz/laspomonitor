...
<!-- Primary Navigation
                ...
                <?php if(auth()->guard()->guest()): ?>
									<li class="menu-item mega-menu">
										<a class="menu-link" href="<?php echo e(URL::to('login')); ?>"><div>Login</div></a>
									</li>

                  <?php else: ?>

              <li class="nav-item">
            <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-primary btn-sm" style="color: #fff;">Dashboard</a> &nbsp; &nbsp;
             </li>
                <li class="nav-item">
...
<?php /**PATH C:\wamp64\www\laspomonitor\resources\views/MainInc/header.blade.php ENDPATH**/ ?>